	...
	<!-- start: Header -->
        ...
        $idLo = $_SESSION["italia"];
				...
				echo '<div class="row-fluid">
									<div class="box span12">
										<div class="box-header">
											<h2><i class="icon-group"></i><span class="break"></span>Sus Trancciones</h2>
										</div>
          ...
          for($i=0;$i<count($getData);$i++){
						...
						$estadoC= $getData[$i]['ESTADO_TRANSACCION'];
						$estado = "Pendiente";
						switch ($estadoC) {
							case '1':
								$estado = "Completa";
							...
							case '2':
								...
								break;
							case '3':
								$estado = "Cancelado por Local";
								break;
							default:
								$estado = "Pendiente";
								break;
						}
						$idCl 	= $getData[$i]['ID_CLIENTE'];
						$objCl 	= new Cliente;
						$getNom = $objCl->mostrarClientePorId($idCl);
						$nombre = $getNom['NOMBRE_CLIENTE']." ".$getNom['APELLIDO_CLIENTE'];
						echo '<tr><td>'.$codigo.'</td><td class="center">'.$monto.'</td><td class="center">'.$fecha.'</td><td class="center">'.$desc.'</td><td class="center">'.$nombre.'</td><td class="center">'.$estado.'</td></tr>';
          }
					echo 			'</tbody>
									 </table>
								</div>
          ...
          echo "<p>Sin Transacciones realizadas aún</p>";
        }
      ?>
	</div><!--/.fluid-container-->
